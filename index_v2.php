...
<body>
    <div class="card">
        ...
        <div class="info">
            ...
            <p><strong>Dibuat oleh:</strong> <?php echo "Nama Kamu"; ?></p>
        ...
        $nama_pembuat = "Agung Doni Prasetyo";
        $alamat_perpus = "jl. Pendidikan no. 123, Kota Batang";
        $telepon_perpus = "0856-0254-7789";
        $jam_buka = "08:00";
        $jam_tutup = "16:30";
        ...
        <div class="info">
            ...
            <p>Buku yang tersedia saat ini adalah <strong><?php echo $persen_tersedia; ?>%</strong></p>
        </div>
    </div>
</body>
</html>